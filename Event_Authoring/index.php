...
<div class="row">
<div class="col-lg-6">
<span class="logo" style="color:#999999">Welcome to Event Authoring Home page</span></div>
<div class="col-md-2 col-md-offset-4">
<a href="#" class="pull-right btn sub1" data-toggle="modal" data-target="#myModal" style="color:#000011"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Sign_in</b></span></a></div>
<!--sign in modal start-->
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content title1" style="background: rgba(0,0,0,.3);">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title title1"><span style="color:#999999">Log In</span></h4>
      </div>
...
<div class="bg1"style="background-image:url(image/load.jpg);">
<div class="row">

<div class="col-md-7"></div>
<div class="col-md-4 panel" style="background: rgba(0,0,0,.3); min-height:430px;">
<!-- sign in form begins -->  
